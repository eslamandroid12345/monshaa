...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employee_permissions' => 'required|array|in:states,lands,employees,expenses,tenants,tenant_contracts,notifications,financial_receipt,financial_cash,technical_support,reports,expired_contracts,revenues,profits,tenant_stats,selling_states',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'employee_permissions.in' => 'states,lands,employees,expenses,tenants,tenant_contracts,notifications,financial_receipt,financial_cash,technical_support,reports,revenues,profits,tenant_stats,selling_states صلاحيات الموظف يجب ان تحتوي علي هذه الشاشات ',
