...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'employee_permissions.in' => 'states,lands,employees,expenses,tenants,tenant_contracts,notifications,financial_receipt,financial_cash,technical_support,reports,revenues,profits,tenant_stats,selling_states,profits,revenue,clients صلاحيات الموظف يجب ان تحتوي علي هذه الشاشات ',
        ];
    }
