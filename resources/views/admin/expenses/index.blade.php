...
<div class="app-topbar">
    ...
    <button class="icon-btn" type="button" title="تحديث" onclick="window.location.href='{{ route('admin.expenses.index') }}'">
        ...
        <table class="props" id="propsTable">
            ...
            @foreach($revenues as $revenue)
             <tr data-id="{{ $revenue->id}}" style="cursor:pointer;">
                ...
                <td class="t-action">
                    <a style="color: #3f5564" href="{{route('admin.expenses.edit',$revenue->id)}}" class="js-edit"><i class="fa-solid fa-file-pen"></i></a>
                </td>
                <td class="t-action">
        ...
        <div class="modal-content search-modal">
            <div class="modal-body p-0">
                <div class="panel-modal">
                    ...
                    <form action="{{ route('admin.expenses.index') }}" method="GET" autocomplete="off">
            ...
            <div class="modal-body p-0">
                ...
                <div id="editModalLoader" class="edit-loader">
                    <div class="loader-box">
                        ...
                        <div class="loader-text">جاري تحميل بيانات المصروف...</div>
                    </div>
                </div>
                <!-- Content -->
...
@if(session('expense_index_error'))
    <div id="loginSuccessBar" class="login-success-bar show">
        {{ session('expense_index_error') }}
    </div>
@endif
...
<script>
    ...
    document.getElementById("searchBtn").addEventListener("click", () => {
        const searchForm = document.querySelector('#searchModal form[action="{{ route('admin.expenses.index') }}"]');
...
<script>
    ...
    document
        .querySelectorAll('form[action="{{ route('admin.expenses.index') }}"]')
        .forEach((form) => {
