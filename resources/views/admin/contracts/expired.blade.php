...
<div class="app-topbar">
    ...
    <div class="title">العقود المنتهيه</div>


    <button class="icon-btn" type="button" title="تحديث" onclick="window.location.href='{{ route('admin.contracts.expired') }}'">
