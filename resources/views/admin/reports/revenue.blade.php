...
<div class="app-topbar">
    ...
    <button class="icon-btn" type="button" title="تحديث" onclick="window.location.href='{{ route('admin.reports.revenues') }}'">
    ...
    <table class="report-table">
        ...
        @foreach($revenues as $revenue)
            <tr data-id="{{ $revenue->id}}" style="cursor:pointer;">
                <td class="c-id">{{$revenue->user?->name}}</td>
                <td class="c-id">{{$revenue->total_money}}</td>
                <td class="c-id">{{$revenue->description}}</td>
                <td class="c-id">{{$revenue->transaction_date}}</td>
        ...
        <div class="modal-content search-modal">
            <div class="modal-body p-0">
                <div class="panel-modal">
                    ...
                    <form action="{{route('admin.reports.revenues')}}" method="GET" autocomplete="off">
...
<script>
    ...
    document.getElementById("searchBtn").addEventListener("click", () => {
        const searchForm = document.querySelector('#searchModal form[action="{{ route('admin.reports.revenues') }}"]');
...
<script>
    ...
    document
        .querySelectorAll('form[action="{{ route('admin.reports.revenues') }}"]')
        .forEach((form) => {
